...
| 완료 | [TASK-254](../tasks/done/254-discover-command-metadata-registry.md) | metadata 소유권 evidence 기록·통합 완료 |
...
| 2 | [TASK-272](../tasks/todo/272-freeze-manifest-route-identity.md) | manifest route identity 표현 사람 승인 기록 |
