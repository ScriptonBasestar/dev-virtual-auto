...
- [ ] Root help, direct help, manifest, shell completion, README/USAGE, canonical skills, and generated projections present canonical and compatibility status consistently | verify: `make generate && make check-generate && make doc-check`
