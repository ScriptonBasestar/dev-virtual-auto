...
func TestConfigEnvCodeSetHasNotDrifted(t *testing.T) {
	want := []string{
		...
		"empty_plaintext_input",
		"encrypt_failed",
		"env_bridge_origin_not_root",
		"env_bridge_requires_version",
		"env_target_not_encrypted",
		"force_unsupported_for_edit",
		"git_unavailable",
		"invalid_dotenv_input",
		"invalid_dotenv_output",
		"json_unsupported_for_edit",
		"json_unsupported_for_seal",
		"json_unsupported_for_show",
